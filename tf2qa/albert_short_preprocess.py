...
# def convert_examples_to_features_(example, is_training, args):
#     """
#     Converts a list of NqExamples into InputFeatures.
#     Args:
#         examples: list
...
#
#
# def convert_examples_to_features(examples, is_training, args):
#     """
...
#             for features_, postive_incremental, negative_incremental in pool.imap(partial(convert_examples_to_features_,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--include_unknowns", type=float, default=0.4,
    ...
    feature_output_file = os.path.join(args.output_dir,
                                       'train_data_maxlen{}_albert_short_features_same.bin'.format(args.max_seq_length))
    if not os.path.exists(feature_output_file):
        ...
        features = convert_examples_to_features(examples=examples, is_training=True, args=args)
