...
# predict
python run_nq.py --model_type bert --model_name_or_path ../output/models/bert-large-uncased-whole-word-masking-finetuned-squad/pytorch_model.bin --config_name ../output/models/bert-large-uncased-whole-word-masking-finetuned-squad/config.json --tokenizer_name ../output/models/bert-large-uncased-whole-word-masking-finetuned-squad/vocab.txt --do_pred --do_lower_case --fp16 --max_seq_length 512 --output_dir ../output/models/bert-large-uncased-whole-word-masking-finetuned-squad/ --per_gpu_eval_batch_size=56 --overwrite_output_dir --predict_file ../input/tensorflow2-question-answering/simplified-nq-test.jsonl --output_prediction_file ../output/models/bert-large-uncased-whole-word-masking-finetuned-squad/predictions_12192019.json --gpu_ids 7