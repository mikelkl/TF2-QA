...
# predict
CUDA_VISIBLE_DEVICES=7 python run_nq.py \
    --model_type bert \
    ...
    --output_prediction_file ../output/models/bert-large-uncased-whole-word-masking-finetuned-squad/predictions_pp1.json