...
# 停用词
stopwords = set()
with open("../input/dataset/stopwords", 'r') as f:
    for line in f:
...
parser.add_argument("--tfidf_test_file", type=str, default='test_cand_selected_600.json')

args = parser.parse_args(args=[])

random.seed(args.seed)
tokenizer = tokenization.FullTokenizer(
    vocab_file='../input/albert-xxlarge/30k-clean.vocab', do_lower_case=True,
    spm_model_file='../input/albert-xxlarge/30k-clean.model')
...
parser.add_argument("--bert_config_file", default='../input/albert-xxlarge/albert_config.json', type=str)
parser.add_argument("--init_restore_dirs", default=['../input/tf2qa-checkpoints/best_checkpoints/best_checkpoints/V0_best_checkpoint.pth',
                                                    '../input/tf2qa-checkpoints/best_checkpoints/best_checkpoints/V01_best_checkpoint.pth',
                                                    '../input/tf2qa-checkpoints/best_checkpoints/best_checkpoints/V2_best_checkpoint.pth',
                                                    '../input/tf2qa-checkpoints/best_checkpoints/best_checkpoints/V3_best_checkpoint.pth'], type=list)
parser.add_argument("--output_dir", default='.', type=str)
parser.add_argument("--dev_feat_dir", default='test_data_maxlen512_albert_tfidf_ls_features.bin', type=str)
...
init_dirs = args.init_restore_dirs
